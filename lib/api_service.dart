...
class ApiService {
  ...
  Future<List<Drink>> getDrinks([int? userID]) async {
    try {
  ...
  Future<void> toggleFavorite(int id, int userID) async {
    try {
  ...
  Future<void> updateCart(CartItem cartItem, int userID) async {
    try {
      final response = await _dio.patch(
  ...
  Future<void> addToCart(CartItem cartItem, int userID) async {
    try {
      final response = await _dio.post(
          '$_baseUrl/cart/$userID',
          data:{
  ...
  Future<void> deleteFromCart(int cartItemID, int userID) async {
    try {
      final response = await _dio.delete(
